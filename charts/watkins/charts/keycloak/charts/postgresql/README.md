...
![Version: 13.2.2](https://img.shields.io/badge/Version-13.2.2-informational?style=flat-square) ![AppVersion: 16.0.0](https://img.shields.io/badge/AppVersion-16.0.0-informational?style=flat-square)
...
| backup.cronjob.containerSecurityContext.readOnlyRootFilesystem | bool | `false` |  |
...
| image.tag | string | `"16.0.0-debian-11-r15"` |  |
| kubeVersion | string | `""` |  |
| ldap.basedn | string | `""` |  |
| ldap.binddn | string | `""` |  |
| ldap.bindpw | string | `""` |  |
...
| metrics.image.tag | string | `"0.15.0-debian-11-r0"` |  |
...
| volumePermissions.image.tag | string | `"11-debian-11-r90"` |  |
