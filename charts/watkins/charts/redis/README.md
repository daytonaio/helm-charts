...
![Version: 17.9.2](https://img.shields.io/badge/Version-17.9.2-informational?style=flat-square) ![AppVersion: 7.0.10](https://img.shields.io/badge/AppVersion-7.0.10-informational?style=flat-square)

Redis(R) is an open source, advanced key-value store. It is often referred to as a data structure server since keys can contain strings, hashes, lists, sets and sorted sets.

**Homepage:** <https://github.com/bitnami/charts/tree/main/bitnami/redis>
...
| image.tag | string | `"7.0.10-debian-11-r2"` |  |
| kubeVersion | string | `""` |  |
...
| metrics.image.tag | string | `"1.48.0-debian-11-r6"` |  |
...
| sentinel.image.tag | string | `"7.0.10-debian-11-r1"` |  |
...
| sysctl.image.tag | string | `"11-debian-11-r99"` |  |
